...
try:
    ...
    for i in range(3):
        ...
        # Le bot cherche si une mission existe dans SA zone
        ...
        status_color = "🟢 ACTIF" if mission_active else "⚪ INACTIF"
        label_cash = f" | 📦 {montant_dans_bot:.2f} $" if montant_dans_bot > 0 else ""

        with st.expander(f"🚜 BOT {p_idx} | {status_color}{label_cash}", expanded=(i==0)):
