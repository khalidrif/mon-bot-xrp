...
if "bots" not in st.session_state:
    ...
    if cfg: 
        ...
        # Création par défaut si Sheets est vide
...
h = st.columns([0.4, 0.4, 0.7, 0.7, 0.7, 1.2, 0.4, 0.6, 0.6, 1])
...
for i in range(1, 51):
    ...
    if not bt: continue
    r = st.columns([0.4, 0.4, 0.7, 0.7, 0.7, 1.2, 0.4, 0.6, 0.6, 1])
    r[0].write(f"#{i}")
