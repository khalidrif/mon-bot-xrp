...
# 1. STYLE "GOLD NANO" (Noir & Jaune Compact)
st.set_page_config(page_title="XRP Gold Nano", layout="wide")
st.markdown("""
    <style>
    ...
    [data-testid="stMetricLabel"] { color: #FFFFFF !important; font-size: 13px !important; }
    ...
    h3 { color: #FFD700 !important; font-size: 16px !important; margin-bottom: 0px !important; }
    .stCaption { color: #888888 !important; font-size: 11px !important; }
    </style>
        ...
        with zone_live.container():
            ...
            for i in range(10):
                ...
                with all_cols[i]:
                    ...
                    st.caption(f"Valeur: {val_live:.2f}$")
